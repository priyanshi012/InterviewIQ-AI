...
function Step1SetUp({onStart}) {
  ...
  if (result.data.filename) {
      await axios.delete(serverUrl + "/api/interview/resume/" + result.data.filename, {
...
<div className='space-y-6'>
  <div className='relative'>
    ...
    className='w-full pl-12 pr-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-green-500 outline-none transition'  onChange={(e)=>setRole(e.target.value)}  value={role}/>
   ...
   <div className='relative'>
    ...
    className='w-full pl-12 pr-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-green-500 outline-none transition'  onChange={(e)=>setExperience(e.target.value)}  value={experience}/>
