...
useEffect(()=>{
 const loadVoices = ()=>{
  ...
  //fallback:find voice (assume female)
...
const speakText = (text)=>{
  return new Promise((resolve)=>{
    ...
    // add natural pasue after commas and periods
...
useEffect(()=>{
  ...
  if(isIntroPhase){
    await speakText(
      `Hi ${userName}, it's great to meet you today. I hope you'
      re feeling confident and ready.`
    );
    await speakText(
      "I'll ask you a few questions. just answer naturally, and take your time. lets begin. "
    );
    setIntroPhase(false)
  }
...
{!isIntroPhase && (<div className="bg-gray-50 p-4 sm:p-6 rounded-2xl border border-gray-200 shadow-sm mb-6">
