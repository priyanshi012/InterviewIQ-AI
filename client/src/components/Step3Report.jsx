...
function Step3Report({ report }) {
 ...
 const DownloadPDF = ()=>{
  ...
  return (
    <div className='min-h-screen bg-gradient-to-br from-gray-50 to-green-50 px-4 sm:py-6 lg:px-10 py-8'>
    ...
    <button 
    onClick={DownloadPDF} 
    className='bg-emerald-600 hover:bg-emerald-700 text-white py-3 rounded-xl shadow-md transition-all duration-300 font-semibold text-sm sm:text-base text-nowrap'>
      Download PDF
    </button>
...
<h3 className='text-gray-500 mb-4 sm:mb-6 text-sm sm:text-base'>
 ...
 <div className='relative w-20 h-20 sm:h-25 mx-auto'>
 ...
 <div className='mt-4'>
  ...
  <p className='text-gray-500 text-xs sm:text-sm mt-1'>
    ...
    <h3 className='text-base sm:text-lh font-semibold text-gray-700 mb-6'>
      Skill Evaluation
    </h3>
