...
import evalImag from '../assets/ai-ans.png'
  ...
  `}>
          ...
          <div className='mb-32'>
            <motion.h2
              ...
              whileInView={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.6 }} className='text-4xl font-semibold text-center mb-16'>
                ...
                [
                  ...
                  <motion.div key={index}
                    ...
                    <div className='flex items-center justify-between gap-6'>
                     ...
                     <div className='w-1/2'>
                     <h3 className='font-semibold text-xl mb-3'>{mode.title}
